  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white  p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-3xl pt-12 font-bold mb-6 text-center">
          Products
        </h1>
        {/* Product Form */}
        <div className="bg-gray-950 rounded-lg shadow-md p-6 mb-8 border border-green-500">
          ...
          <div className="flex space-x-4 mt-4">
            <button
              ...
              className="flex-1 p-3 bg-green-500 text-white rounded hover:bg-green-700 transition flex items-center justify-center space-x-2 disabled:opacity-50"
            >
              <>
                <Plus size={20} />
        ...
        <div className="grid grid-cols-1 gap-4">
          {products.map((product) => (
            <div
              ...
              className="bg-gray-950 border flex justify-end items-center flex-col  border-green-500 rounded-lg p-5 shadow-md"
            >
              ...
              <div className="flex justify-between items-center gap-4">
                ...
                <p className="text-blue-300 text-sm">Stock: {product.stock}</p>
              </div>
            </div>
          ))}
        </div>
