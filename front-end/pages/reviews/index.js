  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-3xl mt-12 font-bold mb-6 text-center">
          Product Reviews
        </h1>

        {/* Review Form */}
        <div className="bg-gray-950 border border-green-500 rounded-lg shadow-md p-6 mb-8">
          ...
          <select
            ...
            className="w-full p-3 mt-4 bg-gray-700 text-white rounded focus:ring-2 focus:ring-green-500 outline-none"
          >
          ...
          <textarea
            ...
            className="w-full p-3 mt-4 bg-gray-700 text-white rounded min-h-[120px] focus:ring-2 focus:ring-green-500 outline-none"
          ></textarea>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full mt-4 p-3 bg-green-600 text-white rounded hover:bg-green-700 transition flex items-center justify-center space-x-2 disabled:opacity-50"
          >
            <span>
              {isLoading
                ? "Processing..."
          ...
          {editingReview && (
            <button
              ...
              className="w-full mt-2 p-3 bg-gray-950 text-white rounded hover:bg-gray-600 transition"
            >
              Cancel Edit
            </button>
          )}
        ...
        <div className="grid grid-cols-1  gap-4">
          {reviews.map((review) => (
            <div
              ...
              className="bg-gray-950  flex justify-center items-center flex-col  border border-green-500 rounded-lg p-5 shadow-md relative"
            >
