  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white p-4 md:p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mt-12 mb-6 text-center">
          Order Management
        </h1>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 gap-4">
            {orders.map((order) => (
              <div
                key={order.order_id}
                className="bg-gray-950 rounded-lg border border-green-500 flex justify-end items-center flex-col  p-5 shadow-md"
              >
